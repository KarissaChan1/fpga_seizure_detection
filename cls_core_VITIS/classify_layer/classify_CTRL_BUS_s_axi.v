...
// ==============================================================
`timescale 1ns/1ps
module classify_CTRL_BUS_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER                  = 6'h08,
    ADDR_ISR                  = 6'h0c,
    ADDR_INPUT_OFFSET_DATA_0  = 6'h10,
    ADDR_INPUT_OFFSET_CTRL    = 6'h14,
    ADDR_OUTPUT_OFFSET_DATA_0 = 6'h18,
    ADDR_OUTPUT_OFFSET_CTRL   = 6'h1c,
    ADDR_NUM_BETA_DATA_0      = 6'h20,
    ADDR_NUM_BETA_CTRL        = 6'h24,
    ADDR_BIAS_DATA_0          = 6'h28,
    ADDR_BIAS_CTRL            = 6'h2c,
    ADDR_SCALE_DATA_0         = 6'h30,
    ADDR_SCALE_CTRL           = 6'h34,
    WRIDLE                    = 2'd0,
    WRDATA                    = 2'd1,
    WRRESP                    = 2'd2,
    WRRESET                   = 2'd3,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_NUM_BETA_DATA_0: begin
                    rdata <= int_NUM_BETA[31:0];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_NUM_BETA_DATA_0)
            int_NUM_BETA[31:0] <= (WDATA[31:0] & wmask) | (int_NUM_BETA[31:0] & ~wmask);
    end
end
